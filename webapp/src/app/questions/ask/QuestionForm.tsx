...
export default function QuestionForm({questionToUpdate}: Props) {
    ...
    return (
        <Form onSubmit={handleSubmit(onSubmit)}
              className='flex flex-col gap-3 p-6 shadow-xl rounded-sm bg-white dark:bg-black'>
            <div className='flex flex-col gap-3 w-full'>
                ...
                <Input
                    ...
                    type='text'
                    className='w-full'
                    label='Be specific and imagine your are asking a question to another person'
            ...
            <Button
                ...
                color={questionToUpdate ? 'secondary' : 'primary'}
                type='submit'
